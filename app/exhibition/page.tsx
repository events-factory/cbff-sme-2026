        ...
        <div style={{ maxWidth: 1160, margin: '0 auto', padding: '0 24px' }}>
          ...
          >
            <div>
              ...
              <p
                style={{ fontSize: 15, color: 'var(--muted)', lineHeight: 1.8 }}
              >
                {T.introBody}
              </p>
            </div>
            ...
            >
              ...
              {[
                ...
                {
                  label:
                    lang === 'fr' ? 'Stands Disponibles' : 'Stands Available',
                  val: lang === 'fr' ? 'Limité' : 'Limited',
                },
              ].map((item) => (
                <div
                  key={item.label}
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto', padding: '0 24px' }}>
          ...
          >
            <div>
              ...
              >
                {lang === 'fr'
                  ? "Manuel de l'Exposant & Plan du Stand"
                  : 'Exhibition Manual & Floor Plan'}
              </p>
              <p style={{ fontSize: 13, color: 'var(--muted)' }}>
                {lang === 'fr'
                  ? "Téléchargez le manuel complet de l'exposant et le plan de la salle d'exposition."
                  : 'Download the complete exhibitor manual and exhibition hall floor plan.'}
              </p>
            </div>
            <a
