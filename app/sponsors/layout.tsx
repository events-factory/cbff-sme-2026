...
export const metadata: Metadata = {
  ...
  description:
    "Sponsor CBFF-SME 2026, the Africa SME finance forum in Kigali, Rwanda (Nov 19–20). Reach 500+ bankers, investors, and policymakers from 30+ countries — Title, Platinum, Gold, and Silver packages with full benefits, audience data, and ROI.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Sponsorship packages, audience data, and partnership opportunities at the Cross-Border Finance Forum for SMEs 2026 — Kigali, Rwanda.",
