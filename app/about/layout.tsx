...
export const metadata: Metadata = {
  ...
  description:
    "Learn about the Continental Business & Finance Forum for SMEs 2026 — its mission, organisers, and the consortium driving Africa's SME finance infrastructure in Kigali, Rwanda.",
  alternates: { canonical: "https://cbffsme.com/about" },
  openGraph: {
    title: "About CBFF-SME 2026 | Continental Business & Finance Forum",
    description:
